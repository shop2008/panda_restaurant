...
router.get('/getConfirmationInfomation', bookingController.getBookingInfo);
...
router.post('/add-bookinginfo', bookingController.postAddBookingData);

// handle to redirect to booking page
router.post('/filter-reservations', bookingController.getFilteredBookings);
